...
(() => {
  ...
  const FUNCIONES = [
    { nom: "Construir IA", serie: 1,
      glosa: "Diseñar, entrenar y armar modelos o agentes <span class='ej'>(PyTorch, LangChain, RAG, LLM, NLP, visión)</span>",
    ...
    { nom: "Poner la IA en producción", serie: 1,
      glosa: "Desplegar, escalar y vigilar que siga funcionando <span class='ej'>(MLOps, MLflow, monitoreo de modelos)</span>",
    ...
    { nom: "Automatizar procesos con IA", serie: 3,
      glosa: "Quitar de en medio el trabajo repetitivo <span class='ej'>(RPA, Power Automate, n8n, orquestación de agentes)</span>",
    ...
    { nom: "Predecir y decidir con IA", serie: 3,
      glosa: "Pronosticar, segmentar y sostener decisiones con datos <span class='ej'>(forecasting, modelos predictivos, series de tiempo)</span>",
    ...
    { nom: "Gobernar la IA", serie: 2,
      glosa: "Estrategia, estándares y reglas de uso <span class='ej'>(gobierno de datos, gobernanza de IA)</span>",
      re: /ai governance|gobierno de datos|gobernanza/ },
    { nom: "Programar con IA", serie: 2,
      glosa: "Escribir código asistido por la herramienta <span class='ej'>(Copilot, Cursor, Claude Code)</span>",
      re: /github copilot|^copilot$|^microsoft copilot$|cursor|claude code/ },
    { nom: "Usar la IA como herramienta", serie: 4, suelta: true,
      glosa: "Manejar el chat y nada más, sin construir ni desplegar <span class='ej'>(ChatGPT, Gemini, prompting)</span>",
