...
(() => {
  ...
  const FUNCIONES = [
    { nom: "Construir IA", serie: 1,
      glosa: "Modelos y agentes: PyTorch, LangChain, RAG, LLM, NLP, visión.",
    ...
    { nom: "Poner la IA en producción", serie: 1,
      glosa: "MLOps, MLflow, despliegue y monitoreo de modelos.",
    ...
    { nom: "Automatizar procesos con IA", serie: 3,
      glosa: "RPA, Power Automate, n8n, orquestación de agentes.",
    ...
    { nom: "Predecir y decidir con IA", serie: 3,
      glosa: "Forecasting, modelos predictivos, series de tiempo, segmentación.",
